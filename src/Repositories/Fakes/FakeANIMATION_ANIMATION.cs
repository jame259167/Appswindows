...
{
    /// <summary>
    /// Fake ANIMATIONSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeANIMATION_ANIMATION : IANIMATION_ANIMATION 
    {
        ...
        public ObservableCollection<Entities.ANIMATIONSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.ANIMATIONSchema> 
			{ 
			...
			return new ObservableCollection<Entities.ANIMATIONSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.ANIMATIONSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of ANIMATIONSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.ANIMATIONSchema>.FilterCollection(filter, GetData());
        }
