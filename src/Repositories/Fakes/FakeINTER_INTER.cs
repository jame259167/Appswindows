...
{
    /// <summary>
    /// Fake INTERSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeINTER_INTER : IINTER_INTER 
    {
        ...
        public ObservableCollection<Entities.INTERSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.INTERSchema> 
			{ 
        ...
        public ObservableCollection<Entities.INTERSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of INTERSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.INTERSchema>.FilterCollection(filter, GetData());
        }
