...
{
    /// <summary>
    /// Fake ThaiSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeThai_Thai : IThai_Thai 
    {
        ...
        public ObservableCollection<Entities.ThaiSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.ThaiSchema> 
			{ 
			...
			return new ObservableCollection<Entities.ThaiSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.ThaiSchema> Refresh(int pageNumber = 0)
