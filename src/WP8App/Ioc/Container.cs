...
namespace WPAppStudio.Ioc
{
    ...
    public class Container : IIoc.IContainer
    {
        ...
        public Container()
        {
            ...
            _currentContainer.RegisterType<IViewModels.IANIMATION_ListViewModel, ViewModels.ANIMATION_ListViewModel>();
            _currentContainer.RegisterType<IViewModels.IINTER_DetailViewModel, ViewModels.INTER_DetailViewModel>();
            _currentContainer.RegisterType<IViewModels.IThai_DetailViewModel, ViewModels.Thai_DetailViewModel>();
            _currentContainer.RegisterType<IViewModels.IANIMATION_DetailViewModel, ViewModels.ANIMATION_DetailViewModel>();
            ...
            {
				_currentContainer.RegisterType<Repositories.IANIMATION_ANIMATION, Repositories.ANIMATION_ANIMATION>(new ContainerControlledLifetimeManager());
				_currentContainer.RegisterType<Repositories.IThai_Thai, Repositories.Thai_Thai>(new ContainerControlledLifetimeManager());
				_currentContainer.RegisterType<Repositories.IINTER_INTER, Repositories.INTER_INTER>(new ContainerControlledLifetimeManager());
			}
			else
			{
				_currentContainer.RegisterType<Repositories.IANIMATION_ANIMATION, Repositories.FakeANIMATION_ANIMATION>(new ContainerControlledLifetimeManager());
				_currentContainer.RegisterType<Repositories.IThai_Thai, Repositories.FakeThai_Thai>(new ContainerControlledLifetimeManager());
				_currentContainer.RegisterType<Repositories.IINTER_INTER, Repositories.FakeINTER_INTER>(new ContainerControlledLifetimeManager());
