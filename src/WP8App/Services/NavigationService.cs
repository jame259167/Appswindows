...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.IANIMATION_ListViewModel), "/View/ANIMATION_List.xaml" },
            { typeof(IViewModels.IINTER_DetailViewModel), "/View/INTER_Detail.xaml" },
            { typeof(IViewModels.IThai_DetailViewModel), "/View/Thai_Detail.xaml" },
            { typeof(IViewModels.IANIMATION_DetailViewModel), "/View/ANIMATION_Detail.xaml" },
