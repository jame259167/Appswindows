...
{
    /// <summary>
    /// Phone application page for ANIMATION_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class ANIMATION_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for ANIMATION_Detail and all its components.
        /// </summary>
        public ANIMATION_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaANIMATION_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaANIMATION_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaANIMATION_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaANIMATION_Detail(PanoramaANIMATION_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaANIMATION_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IANIMATION_ANIMATION>();
				AddHomeAppBarButton();
				...
				((IViewModels.IANIMATION_DetailViewModel)DataContext).CurrentANIMATIONSchema = pinnedItem;				
			}
		}
        ...
        private void AddHomeAppBarButton()
        {
			...
			{ 
				new Ioc.Container().Resolve<IServices.INavigationService>().NavigateTo<IViewModels.IANIMATION_ListViewModel>(); 
