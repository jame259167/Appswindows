...
{
    /// <summary>
    /// Phone application page for INTER_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class INTER_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for INTER_Detail and all its components.
        /// </summary>
        public INTER_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaINTER_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaINTER_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaINTER_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaINTER_Detail(PanoramaINTER_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaINTER_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IINTER_INTER>();
				AddHomeAppBarButton();
				...
				((IViewModels.IINTER_DetailViewModel)DataContext).CurrentINTERSchema = pinnedItem;				
			}
		}
