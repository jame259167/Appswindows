...
{
    /// <summary>
    /// Phone application page for Thai_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Thai_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Thai_Detail and all its components.
        /// </summary>
        public Thai_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaThai_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaThai_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaThai_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaThai_Detail(PanoramaThai_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaThai_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IThai_Thai>();
				AddHomeAppBarButton();
				...
				((IViewModels.IThai_DetailViewModel)DataContext).CurrentThaiSchema = pinnedItem;				
			}
		}
